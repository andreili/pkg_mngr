...
INSERT INTO "install_cmds" VALUES(182,86,'mv usr/lib usr/lib64','${BIN_DIR}',NULL);
...
INSERT INTO "config_cmds" VALUES(32,34,'BUILD_ZLIB=False BUILD_BZIP2=0 sh Configure -${OPT berkdb FLAGOFF U}${OPT berkdb FLAGON D}i_ndbm -${OPT gdbm FLAGOFF U}${OPT gdbm FLAGON D}i_gdbm -${OPT berkdb FLAGOFF U}${OPT berkdb FLAGON D}i_db -Dusethreads -DDEBUGGING=none ''-Dlibpth=/usr/lib64 /lib64 /lib/*-linux-gnu /usr/lib/*-linux-gnu /lib64 /lib/64 /usr/lib64 /usr/lib/64 /lib32 /usr/lib32 /lib /usr/lib'' -Dnoextensions=1 -Duseshrplib -Dprefix=/usr -Dsiteprefix=''/usr/local'' -Dvendorprefix=''/usr'' -Dscriptdir=''/usr/bin'' -Dman1ext=''1'' -Dman3ext=''3pm'' -Dman1dir=/usr/share/man/man1 -Dman3dir=/usr/share/man/man3 -Dlocincpth=''/usr/include '' -Duselargefiles -Dd_semctl_semun -Dcf_by=''LFS'' -Dmyhostname=''localhost'' -Dperladmin=''root@localhost'' -Ud_csh -Dsh=/bin/sh -Dtargetsh=/bin/sh -Uusenm -des -Dinstallprefix=''/usr''','${SRC_DIR}/${PS}-${PV}',NULL);
...
INSERT INTO "config_cmds" VALUES(54,57,'${SRC_DIR}/${PS}-${PV}/configure ${CONFIG_DEF} --localstatedir=/var ${OPT static-libs ENDIS static} --disable-doxygen-docs --disable-xml-docs --docdir=/usr/share/doc/${PN}-${PV} --with-console-auth-dir=/run/console','${BUILD_DIR}',NULL);
...
INSERT INTO "sqlite_sequence" VALUES('package',107);
INSERT INTO "sqlite_sequence" VALUES('config_aliases',7);
INSERT INTO "sqlite_sequence" VALUES('prepare_cmds',108);
INSERT INTO "sqlite_sequence" VALUES('pkg_deps',291);
INSERT INTO "sqlite_sequence" VALUES('config_opts',460);
INSERT INTO "sqlite_sequence" VALUES('set_pkgs',34);
INSERT INTO "sqlite_sequence" VALUES('pkg_opts',309);
INSERT INTO "sqlite_sequence" VALUES('package_meta',110);
INSERT INTO "sqlite_sequence" VALUES('postinstall_cmds',134);
INSERT INTO "sqlite_sequence" VALUES('package_sources',133);
INSERT INTO "sqlite_sequence" VALUES('install_cmds',194);
INSERT INTO "sqlite_sequence" VALUES('config_cmds',105);
INSERT INTO "sqlite_sequence" VALUES('postinst_msg',1);
INSERT INTO "sqlite_sequence" VALUES('sets',2);
INSERT INTO "sqlite_sequence" VALUES('make_cmds',115);
