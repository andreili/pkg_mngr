...
INSERT INTO "package" VALUES(66,68,'1.60_p20161110235919','net-tools');
...
INSERT INTO "prepare_cmds" VALUES(30,42,'sed -i -e ''s/GROUP="dialout"/GROUP="uucp"/'' rules/*.rules','${SRC_DIR}/${PS}-${PV}',NULL);
...
INSERT INTO "prepare_cmds" VALUES(58,99,'sed -i ''/CMAKE_USE_LIBUV 1/s/1/0/'' CMakeLists.txt','${SRC_DIR}/${PS}-${PV}',NULL);
INSERT INTO "prepare_cmds" VALUES(59,99,'sed -i ''/"lib64"/s/64//'' Modules/GNUInstallDirs.cmake','${SRC_DIR}/${PS}-${PV}',NULL);
INSERT INTO "prepare_cmds" VALUES(61,73,'sed -i -r -e ''/^CFLAGS/d'' -e ''/CFLAGS/s:-O[0-9]?:${CFLAGS} ${CPPFLAGS}:'' -e ''/^STRIP/s:=.*:=true:'' -e ''s:LF2 = -s:LF2 = :'' -e ''s:LF = :LF = ${LDFLAGS} :'' -e ''s:SL = :SL = ${LDFLAGS} :'' -e ''s:FL = :FL = ${LDFLAGS} :'' -e "/^#L_BZ2/s:^${OPT bzip2 FLAGON .}::" unix/Makefile','${SRC_DIR}/${PS}${PV}',NULL);
INSERT INTO "prepare_cmds" VALUES(62,73,'rm -r bzip2','${SRC_DIR}/${PS}${PV}',NULL);
INSERT INTO "prepare_cmds" VALUES(64,96,'find \( -name build.xml -o -name build.properties \) -printf "removed %p\n" -delete','${SRC_DIR}/${PS}-${PV}',NULL);
INSERT INTO "prepare_cmds" VALUES(66,102,'sed -e ''/chmod/s:555:755:g'' -i Makefile.in','${SRC_DIR}/${PS}${PV}/unix',NULL);
INSERT INTO "prepare_cmds" VALUES(67,102,'sed -e ''s:-O[2s]\?::g'' -i tcl.m4','${SRC_DIR}/${PS}${PV}/unix',NULL);
INSERT INTO "prepare_cmds" VALUES(68,102,'mv configure.{in,ac}','${SRC_DIR}/${PS}${PV}/unix',NULL);
INSERT INTO "prepare_cmds" VALUES(69,102,'autoconf','${SRC_DIR}/${PS}${PV}/unix',NULL);
INSERT INTO "prepare_cmds" VALUES(70,84,'sed -i -e ''/udevadm hwdb/d'' Makefile','${SRC_DIR}/${PS}-${PV}',NULL);
INSERT INTO "prepare_cmds" VALUES(71,103,'sed -i -e ''/SystemdService/d'' data/org.freedesktop.ConsoleKit.service.in','${SRC_DIR}/${PS}-${PV}',NULL);
INSERT INTO "prepare_cmds" VALUES(72,76,'sed -r -i -e "/^DB_RELEASE_DATE=/s~=.*~=''$(awk ''/^DB_VERSION_STRING=/{ gsub(".*\\(|\\).*","",$0); print $0; }'' dist/configure)''~g" dist/RELEASE','${SRC_DIR}/${PS}-${PV}',NULL);
INSERT INTO "prepare_cmds" VALUES(73,76,'sed -r -i -e ''/jarfile=.*\.jar$/s,(.jar$),-$(LIBVERSION)\1,g'' dist/Makefile.in','${SRC_DIR}/${PS}-${PV}',NULL);
INSERT INTO "prepare_cmds" VALUES(74,76,'rm -f aclocal/libtool.m4','${SRC_DIR}/${PS}-${PV}/dist',NULL);
INSERT INTO "prepare_cmds" VALUES(75,76,'sed -i -e ''/AC_PROG_LIBTOOL$/aLT_OUTPUT'' configure.ac','${SRC_DIR}/${PS}-${PV}/dist',NULL);
INSERT INTO "prepare_cmds" VALUES(76,76,'sed -i -e ''/^AC_PATH_TOOL/s/ sh, none/ bash, none/'' aclocal/programs.m4','${SRC_DIR}/${PS}-${PV}/dist',NULL);
INSERT INTO "prepare_cmds" VALUES(79,76,'AT_M4DIR="aclocal aclocal_java" autoreconf || echo "autoreconf"','${SRC_DIR}/${PS}-${PV}/dist',NULL);
INSERT INTO "prepare_cmds" VALUES(80,27,'sed -i -e ''/LOCAL_LDFLAGS=/s:-rdynamic::'' configure','${SRC_DIR}/${PS}-${PV}',NULL);
INSERT INTO "prepare_cmds" VALUES(81,27,'export ac_cv_func_dl{close,open,sym}=no ac_cv_lib_dl_dlopen=no ac_cv_header_dlfcn_h=no','${SRC_DIR}/${PS}-${PV}',NULL);
INSERT INTO "prepare_cmds" VALUES(82,52,'sed -i -e ''/^SUBDIRS=/s:=.*:=lib tc ip:'' Makefile','${SRC_DIR}/${PS}-${PV}',9);
INSERT INTO "prepare_cmds" VALUES(85,26,'patch -Np0 -i ${PKG_SOURCES}/readline-5.0-no_rpath.patch','${SRC_DIR}/${PS}-${PV}',NULL);
INSERT INTO "prepare_cmds" VALUES(86,26,'patch -Np3 -i ${PKG_SOURCES}/readline-6.2-rlfe-tgoto.patch','${SRC_DIR}/${PS}-${PV}',NULL);
INSERT INTO "prepare_cmds" VALUES(87,26,'patch -Np3 -i ${PKG_SOURCES}/readline-7.0-headers.patch','${SRC_DIR}/${PS}-${PV}',NULL);
INSERT INTO "prepare_cmds" VALUES(88,26,'patch -Np3 -i ${PKG_SOURCES}/readline-7.0-missing-echo-proto.patch','${SRC_DIR}/${PS}-${PV}',NULL);
INSERT INTO "prepare_cmds" VALUES(89,26,'sed -i -e ''/objformat/s:if .*; then:if true; then:'' support/shobj-conf','${SRC_DIR}/${PS}-${PV}',NULL);
INSERT INTO "prepare_cmds" VALUES(90,26,'ln -s ../.. examples/rlfe/readline','${SRC_DIR}/${PS}-${PV}',NULL);
INSERT INTO "prepare_cmds" VALUES(91,26,'sed -i -e "/^SHLIB_LIBS=/s:=.*:=''-lncurses -ltinfo'':" support/shobj-conf','${SRC_DIR}/${PS}-${PV}',NULL);
INSERT INTO "prepare_cmds" VALUES(92,26,'sed -i -e "/^[[:space:]]*LIBS=.-lncurses/s:-lncurses:-lncurses -ltinfo:" examples/rlfe/configure','${SRC_DIR}/${PS}-${PV}',NULL);
INSERT INTO "prepare_cmds" VALUES(95,107,'sed -i -e ''s:@toolexeclibdir@:$(libdir):g'' Makefile.in','${SRC_DIR}/${PS}-${PV}',NULL);
INSERT INTO "prepare_cmds" VALUES(96,107,'sed -e ''/^includesdir/ s/$(libdir).*$/$(includedir)/'' -i include/Makefile.in','${SRC_DIR}/${PS}-${PV}',NULL);
INSERT INTO "prepare_cmds" VALUES(98,106,'sed -i -e ''s/ tests//'' {.,gio,glib}/Makefile.am','${SRC_DIR}/${PS}-${PV}',NULL);
INSERT INTO "prepare_cmds" VALUES(99,106,'autoreconf','${SRC_DIR}/${PS}-${PV}',NULL);
INSERT INTO "prepare_cmds" VALUES(100,81,'sed -i -e ''/_LDFLAGS/s:-static::'' tools/Makefile.in','${SRC_DIR}/${PS}-${PV}',NULL);
INSERT INTO "prepare_cmds" VALUES(101,42,'patch -Np1 -i ${PKG_SOURCES}/233-0001-Avoid-strict-DM-interface-version-dependencies-5519.patch','${SRC_DIR}/${PS}-${PV}',NULL);
INSERT INTO "prepare_cmds" VALUES(102,42,'sed -i s/size_t/GPERF_LEN_TYPE/ src/resolve/dns_type-from-name.h','${SRC_DIR}/${PS}-${PV}',NULL);
INSERT INTO "prepare_cmds" VALUES(103,49,'sed -i -e ''s/^[ \t]\+g=g$/g=/'' configure','${SRC_DIR}/${PS}-${PV}',NULL);
INSERT INTO "prepare_cmds" VALUES(104,27,'sed -i -r ''/^(HS|RL)USER/s:=.*:=:'' doc/Makefile.in','${SRC_DIR}/${PS}-${PV}',NULL);
INSERT INTO "prepare_cmds" VALUES(107,3,'mv ../extra/c_stubs ./','${SRC_DIR}/${PS}-${PV}',NULL);
INSERT INTO "prepare_cmds" VALUES(108,49,'patch -Np1 -i ${PKG_SOURCES}/groff-1.22.3-parallel-mom.patch','${SRC_DIR}/${PS}-${PV}',NULL);
INSERT INTO "prepare_cmds" VALUES(109,108,'sed -i "s/return 1/exit 1/g" tests/test_rhash.sh','${SRC_DIR}/${PS}-${PV}',NULL);
INSERT INTO "prepare_cmds" VALUES(110,66,'sed -i -e "/^bool.* HAVE_HWTR /s:[yn]$:y:" config.in','${SRC_DIR}/${PS}-${PV}',NULL);
INSERT INTO "prepare_cmds" VALUES(111,66,'sed -i -e "/^bool.* HAVE_HWSTRIP /s:[yn]$:n:" config.in','${SRC_DIR}/${PS}-${PV}',NULL);
INSERT INTO "prepare_cmds" VALUES(112,66,'sed -i -e "/^bool.* HAVE_SELINUX /s:[yn]$:n:" config.in','${SRC_DIR}/${PS}-${PV}',NULL);
INSERT INTO "prepare_cmds" VALUES(113,66,'sed -i -e "/^bool.* HAVE_ARP_TOOLS /s:[yn]$:y:" config.in','${SRC_DIR}/${PS}-${PV}',NULL);
INSERT INTO "prepare_cmds" VALUES(114,66,'sed -i -e "/^bool.* HAVE_HOSTNAME_TOOLS /s:[yn]$:y:" config.in','${SRC_DIR}/${PS}-${PV}',NULL);
INSERT INTO "prepare_cmds" VALUES(115,66,'sed -i -e "/^bool.* HAVE_HOSTNAME_SYMLINKS /s:[yn]$:${OPT nis EXP_YN ipv6}:" config.in','${SRC_DIR}/${PS}-${PV}',NULL);
INSERT INTO "prepare_cmds" VALUES(116,66,'sed -i -e "/^bool.* HAVE_PLIP_TOOLS /s:[yn]$:n:" config.in','${SRC_DIR}/${PS}-${PV}',NULL);
INSERT INTO "prepare_cmds" VALUES(117,66,'sed -i -e "/^bool.* HAVE_SERIAL_TOOL /s:[yn]$:n:" config.in','${SRC_DIR}/${PS}-${PV}',NULL);
INSERT INTO "prepare_cmds" VALUES(118,66,'sed -i "s/#include <linux\/if_tr.h>/#include <netinet\/if_tr.h>/" lib/tr.c','${SRC_DIR}/${PS}-${PV}',NULL);
...
INSERT INTO "pkg_deps" VALUES(79,37,0,NULL);
...
INSERT INTO "pkg_deps" VALUES(208,87,0,409);
...
INSERT INTO "pkg_deps" VALUES(253,102,103,NULL);
INSERT INTO "pkg_deps" VALUES(254,102,35,NULL);
INSERT INTO "pkg_deps" VALUES(255,102,65,NULL);
INSERT INTO "pkg_deps" VALUES(256,102,4,NULL);
INSERT INTO "pkg_deps" VALUES(257,102,14,NULL);
INSERT INTO "pkg_deps" VALUES(258,102,15,40);
INSERT INTO "pkg_deps" VALUES(259,103,17,7);
INSERT INTO "pkg_deps" VALUES(260,103,13,99);
INSERT INTO "pkg_deps" VALUES(261,103,35,148);
INSERT INTO "pkg_deps" VALUES(262,103,1,0);
INSERT INTO "pkg_deps" VALUES(263,103,73,461);
INSERT INTO "pkg_deps" VALUES(264,103,42,0);
INSERT INTO "pkg_deps" VALUES(265,103,4,18);
INSERT INTO "pkg_deps" VALUES(266,103,64,NULL);
INSERT INTO "pkg_deps" VALUES(267,103,104,248);
INSERT INTO "pkg_deps" VALUES(268,75,13,99);
INSERT INTO "pkg_deps" VALUES(269,81,28,471);
INSERT INTO "pkg_deps" VALUES(272,91,105,472);
INSERT INTO "pkg_deps" VALUES(273,105,43,NULL);
INSERT INTO "pkg_deps" VALUES(274,105,58,NULL);
INSERT INTO "pkg_deps" VALUES(275,105,4,NULL);
INSERT INTO "pkg_deps" VALUES(276,105,17,7);
INSERT INTO "pkg_deps" VALUES(279,105,97,NULL);
INSERT INTO "pkg_deps" VALUES(280,105,68,NULL);
INSERT INTO "pkg_deps" VALUES(281,106,37,0);
INSERT INTO "pkg_deps" VALUES(282,65,106,44);
INSERT INTO "pkg_deps" VALUES(283,70,106,44);
INSERT INTO "pkg_deps" VALUES(284,106,107,NULL);
INSERT INTO "pkg_deps" VALUES(285,108,100,0);
INSERT INTO "pkg_deps" VALUES(286,108,97,NULL);
INSERT INTO "pkg_deps" VALUES(287,108,43,NULL);
INSERT INTO "pkg_deps" VALUES(288,108,82,NULL);
INSERT INTO "pkg_deps" VALUES(289,108,4,NULL);
INSERT INTO "pkg_deps" VALUES(290,108,109,NULL);
INSERT INTO "pkg_deps" VALUES(292,102,110,NULL);
INSERT INTO "pkg_deps" VALUES(293,110,43,5);
INSERT INTO "pkg_deps" VALUES(294,110,64,55);
...
INSERT INTO "pkg_opts" VALUES(189,68,291,1,NULL);
...
INSERT INTO "postinstall_cmds" VALUES(4,3,'install -Dm644 ${SRC_DIR}/${PS}-${PV}/nscd/nscd.tmpfiles ${BIN_DIR}/usr/lib64/tmpfiles.d/nscd.conf',NULL,NULL);
INSERT INTO "postinstall_cmds" VALUES(5,3,'install -Dm644 ${SRC_DIR}/${PS}-${PV}/nscd/nscd.service ${BIN_DIR}/lib64/systemd/system/nscd.service',NULL,NULL);
...
EOF
',NULL,NULL);
INSERT INTO "postinstall_cmds" VALUES(7,3,'mkdir -p ${BIN_DIR}/usr/lib64/locale','${BIN_DIR}',NULL);
...
INSERT INTO "postinstall_cmds" VALUES(14,5,'mkdir -p ${BIN_DIR}/lib64/','${BIN_DIR}',NULL);
INSERT INTO "postinstall_cmds" VALUES(15,5,'mv ${BIN_DIR}/usr/lib64/libz.so.* ${BIN_DIR}/lib64/','${BIN_DIR}',NULL);
INSERT INTO "postinstall_cmds" VALUES(18,5,'ln -sfv ../../lib64/$(readlink ${BIN_DIR}/lib64/libz.so) ${BIN_DIR}/usr/lib64/libz.so','${BIN_DIR}',NULL);
INSERT INTO "postinstall_cmds" VALUES(20,11,'ln -s ../usr/bin/cpp ${BIN_DIR}/lib64/','${BIN_DIR}',NULL);
INSERT INTO "postinstall_cmds" VALUES(21,11,'ln -s gcc ${BIN_DIR}/usr/bin/cc','${BIN_DIR}',NULL);
INSERT INTO "postinstall_cmds" VALUES(22,11,'install -dm755 ${BIN_DIR}/usr/lib64/bfd-plugins','${BIN_DIR}',NULL);
INSERT INTO "postinstall_cmds" VALUES(23,11,'ln -sf ../../libexec/gcc/$(gcc -dumpmachine)/${PV}/liblto_plugin.so ${BIN_DIR}/usr/lib64/bfd-plugins/','${BIN_DIR}',NULL);
INSERT INTO "postinstall_cmds" VALUES(24,11,'mkdir -p ${BIN_DIR}/usr/share/gdb/auto-load/usr/lib','${BIN_DIR}',NULL);
INSERT INTO "postinstall_cmds" VALUES(25,11,'mv ${BIN_DIR}/usr/lib64/*gdb.py ${BIN_DIR}/usr/share/gdb/auto-load/usr/lib','${BIN_DIR}',NULL);
INSERT INTO "postinstall_cmds" VALUES(26,12,'mkdir -p ${BIN_DIR}/{bin,lib64,usr/lib64,usr/include}','${BIN_DIR}',NULL);
INSERT INTO "postinstall_cmds" VALUES(27,12,'cp bzip2-shared ${BIN_DIR}/bin/bzip2','${SRC_DIR}/${PS}-${PV}',NULL);
INSERT INTO "postinstall_cmds" VALUES(28,12,'cp -a libbz2.so* ${BIN_DIR}/lib64/','${SRC_DIR}/${PS}-${PV}',NULL);
INSERT INTO "postinstall_cmds" VALUES(29,12,'ln -s ../../lib64/libbz2.so.1.0 ${BIN_DIR}/usr/lib64/libbz2.so','${SRC_DIR}/${PS}-${PV}',NULL);
...
INSERT INTO "postinstall_cmds" VALUES(34,14,'mkdir -p ${BIN_DIR}/{lib64,usr/lib64/pkgconfig}','${BIN_DIR}',NULL);
INSERT INTO "postinstall_cmds" VALUES(35,14,'mv -v ${BIN_DIR}/usr/lib64/libncursesw.so.6* ${BIN_DIR}/lib64/','${BIN_DIR}',21);
INSERT INTO "postinstall_cmds" VALUES(36,14,'ln -sfv ../../lib64/$(readlink ${BIN_DIR}/usr/lib64/libncursesw.so) ${BIN_DIR}/usr/lib64/libncursesw.so','${BIN_DIR}',21);
...
INSERT INTO "postinstall_cmds" VALUES(38,14,'rm vf  ${BIN_DIR}/usr/lib64/libcursesw.so','${BIN_DIR}',21);
INSERT INTO "postinstall_cmds" VALUES(39,14,'echo "INPUT(-lncursesw)" > ${BIN_DIR}/usr/lib64/libcursesw.so','${BIN_DIR}',21);
INSERT INTO "postinstall_cmds" VALUES(43,15,'chmod 0755 ${BIN_DIR}/usr/lib64/libattr.so','${BIN_DIR}',NULL);
INSERT INTO "postinstall_cmds" VALUES(44,15,'mv ${BIN_DIR}/usr/lib64/libattr.so.* ${BIN_DIR}/lib64/','${BIN_DIR}',NULL);
INSERT INTO "postinstall_cmds" VALUES(45,15,'ln -sfv ../../lib64/$(readlink ${BIN_DIR}/usr/lib64/libattr.so) ${BIN_DIR}/usr/lib64/libattr.so','${BIN_DIR}',NULL);
INSERT INTO "postinstall_cmds" VALUES(46,16,'chmod 755 ${BIN_DIR}/usr/lib64/libacl.so','${BIN_DIR}',NULL);
INSERT INTO "postinstall_cmds" VALUES(47,16,'mv ${BIN_DIR}/usr/lib64/libacl.so.* ${BIN_DIR}/lib64','${BIN_DIR}',NULL);
INSERT INTO "postinstall_cmds" VALUES(48,16,'ln -sf ../../lib64/$(readlink ${BIN_DIR}/usr/lib64/libacl.so) ${BIN_DIR}/usr/lib64/libacl.so','${BIN_DIR}',NULL);
INSERT INTO "postinstall_cmds" VALUES(49,17,'chmod -v 755 ${BIN_DIR}/usr/lib64/libcap.so','${BIN_DIR}',NULL);
INSERT INTO "postinstall_cmds" VALUES(50,17,'mv -v ${BIN_DIR}/usr/lib64/libcap.so.* ${BIN_DIR}/lib64','${BIN_DIR}',NULL);
INSERT INTO "postinstall_cmds" VALUES(51,17,'ln -sfv ../../lib64/$(readlink ${BIN_DIR}/usr/lib64/libcap.so) ${BIN_DIR}/usr/lib64/libcap.so','${BIN_DIR}',NULL);
...
INSERT INTO "postinstall_cmds" VALUES(57,26,'mv ${BIN_DIR}/usr/lib64/lib{readline,history}.so.* ${BIN_DIR}/lib64','${BIN_DIR}',NULL);
INSERT INTO "postinstall_cmds" VALUES(58,26,'ln -sf ../../lib64/$(readlink ${BIN_DIR}/usr/lib64/libreadline.so) ${BIN_DIR}/usr/lib64/libreadline.so','${BIN_DIR}',NULL);
INSERT INTO "postinstall_cmds" VALUES(59,26,'ln -sf ../../lib64/$(readlink ${BIN_DIR}/usr/lib64/libhistory.so ) ${BIN_DIR}/usr/lib64/libhistory.so','${BIN_DIR}',NULL);
...
INSERT INTO "postinstall_cmds" VALUES(65,39,'mkdir -p ${BIN_DIR}/{bin,lib64}','${BIN_DIR}',NULL);
INSERT INTO "postinstall_cmds" VALUES(66,39,'mv ${BIN_DIR}/usr/bin/{lzma,unlzma,lzcat,xz,unxz,xzcat} ${BIN_DIR}/bin','${BIN_DIR}',NULL);
INSERT INTO "postinstall_cmds" VALUES(67,39,'mv ${BIN_DIR}/usr/lib64/liblzma.so.* ${BIN_DIR}/lib64','${BIN_DIR}',NULL);
INSERT INTO "postinstall_cmds" VALUES(68,39,'ln -sf ../../lib64/$(readlink ${BIN_DIR}/usr/lib64/liblzma.so) ${BIN_DIR}/usr/lib64/liblzma.so','${BIN_DIR}',NULL);
...
INSERT INTO "postinstall_cmds" VALUES(74,42,'rm -rf ${BIN_DIR}/usr/lib64/rpm','${BIN_DIR}',NULL);
INSERT INTO "postinstall_cmds" VALUES(75,42,'ln -sf /usr/lib64/systemd/resolv.conf ${BIN_DIR}/etc/resolv.conf','${BIN_DIR}',NULL);
...
INSERT INTO "postinstall_cmds" VALUES(77,42,'ln -sf /usr/lib64/systemd/systemd ${BIN_DIR}/sbin/init','${BIN_DIR}',NULL);
...
EOF
','${BIN_DIR}',NULL);
INSERT INTO "postinstall_cmds" VALUES(85,43,'mkdir ${BIN_DIR}/lib64','${BIN_DIR}',NULL);
INSERT INTO "postinstall_cmds" VALUES(86,43,'mv ${BIN_DIR}/usr/lib64/libprocps.so.* ${BIN_DIR}/lib64','${BIN_DIR}',NULL);
INSERT INTO "postinstall_cmds" VALUES(87,43,'ln -sf ../../lib64/$(readlink ${BIN_DIR}/usr/lib64/libprocps.so) ${BIN_DIR}/usr/lib64/libprocps.so','${BIN_DIR}',NULL);
...
INSERT INTO "postinstall_cmds" VALUES(109,78,'ln -sfv ../../sbin/xtables-multi $BIN_DIR}/usr/bin/iptables-xml','${BUILD_DIR}',NULL);
...
INSERT INTO "postinstall_cmds" VALUES(111,78,'make DESTDIR=${BIN_DIR} install-iptables','${SRC_DIR}/blfs-systemd-units-20160602',NULL);
INSERT INTO "postinstall_cmds" VALUES(112,77,'mkdir -p ${BIN_DIR}/lib','${BUILD_DIR}',NULL);
INSERT INTO "postinstall_cmds" VALUES(114,77,'mv ${BIN_DIR}/usr/lib/libtirpc.so.* ${BIN_DIR}/lib','${BUILD_DIR}',NULL);
INSERT INTO "postinstall_cmds" VALUES(115,77,'ln -sf ../../lib/libtirpc.so.3.0.0 ${BIN_DIR}/usr/lib/libtirpc.so','${BUILD_DIR}',NULL);
INSERT INTO "postinstall_cmds" VALUES(117,84,'udevadm hwdb --update --root=${ROOT}','${BIN_DIR}',409);
INSERT INTO "postinstall_cmds" VALUES(118,72,'create-cracklib-dict ${BIN_DIR}/usr/share/dict/*','${BUILD_DIR}',NULL);
INSERT INTO "postinstall_cmds" VALUES(119,3,'mkdir -p ${BIN_DIR}/etc/ld.so.conf.d/','${BIN_DIR}',NULL);
...
','${BIN_DIR}',NULL);
INSERT INTO "postinstall_cmds" VALUES(121,5,'rm -r lib','${BIN_DIR}',NULL);
INSERT INTO "postinstall_cmds" VALUES(123,75,'install -m755 -d ${BIN_DIR}/etc/pam.d','${BIN_DIR}',NULL);
...
EOF
','${BIN_DIR}',NULL);
INSERT INTO "postinstall_cmds" VALUES(125,75,'chmod  4755 ${BIN_DIR}/sbin/unix_chkpwd','${BIN_DIR}',NULL);
...
# End /etc/pam.d/other
EOF','${BIN_DIR}',NULL);
INSERT INTO "postinstall_cmds" VALUES(133,84,'mv lib lib64','${BIN_DIR}',NULL);
INSERT INTO "postinstall_cmds" VALUES(134,78,'rm -r usr/lib','${BIN_DIR}',NULL);
INSERT INTO "postinstall_cmds" VALUES(135,57,'mv ${BIN_DIR}var/run ${BIN_DIR}','${BIN_DIR}',NULL);
INSERT INTO "postinstall_cmds" VALUES(136,78,'mv lib lib64','${BIN_DIR}',NULL);
...
INSERT INTO "package_sources" VALUES(80,66,'http://distfiles.gentoo.org/distfiles/net-tools-${PV}.tar.xz','df30eda79f2a791957874eb9c63975f9',227552);
...
INSERT INTO "install_cmds" VALUES(4,3,'mkdir -p {usr/,}lib64','${BIN_DIR}',NULL);
INSERT INTO "install_cmds" VALUES(11,3,'mkdir -p etc','${BIN_DIR}',NULL);
INSERT INTO "install_cmds" VALUES(15,4,'make DESTDIR=${BIN_DIR} install TOPDIR=/usr REDO=posix_only','${SRC_DIR}',NULL);
...
INSERT INTO "install_cmds" VALUES(26,11,'mkdir -p ${BIN_DIR}/{lib64,usr}','${BIN_DIR}',NULL);
...
INSERT INTO "install_cmds" VALUES(38,15,'mkdir -p ${BIN_DIR}/{lib64,usr/lib64/pkgconfig}','${SRC_DIR}/${PS}-${PV}',NULL);
INSERT INTO "install_cmds" VALUES(39,15,'make DESTDIR=${BIN_DIR} install install-dev install-lib','${SRC_DIR}/${PS}-${PV}',NULL);
INSERT INTO "install_cmds" VALUES(40,16,'mkdir -p ${BIN_DIR}/{lib64,usr/lib64/pkgconfig}','${SRC_DIR}/${PS}-${PV}',NULL);
INSERT INTO "install_cmds" VALUES(41,16,'make DESTDIR=${BIN_DIR} install install-dev install-lib','${SRC_DIR}/${PS}-${PV}',NULL);
INSERT INTO "install_cmds" VALUES(42,17,'mkdir -p ${BIN_DIR}/{lib64,usr/lib64}','${SRC_DIR}/${PS}-${PV}',NULL);
...
INSERT INTO "install_cmds" VALUES(53,26,'mkdir -p ${BIN_DIR}/lib64','${BUILD_DIR}',NULL);
INSERT INTO "install_cmds" VALUES(54,26,'make DESTDIR=${BIN_DIR} install','${BUILD_DIR}',NULL);
...
INSERT INTO "install_cmds" VALUES(81,52,'make DOCDIR=/usr/share/doc/${PN}-${PV} DESTDIR=${BIN_DIR} LIBDIR=/usr/lib64 SBINDIR=/sbin CONFDIR=/etc/iproute2 MANDIR=/usr/share/man ARPDIR=/var/lib/arpd install','${SRC_DIR}/${PS}-${PV}',NULL);
...
INSERT INTO "install_cmds" VALUES(108,32,'cp expat.pc expatu.pc','${BIN_DIR}/usr/lib64/pkgconfig',21);
INSERT INTO "install_cmds" VALUES(109,32,'sed -i -e ''/^Libs/s:-lexpat:&u:'' expatu.pc','${BIN_DIR}/usr/lib64/pkgconfig',21);
INSERT INTO "install_cmds" VALUES(110,32,'cp expat.pc expatw.pc','${BIN_DIR}/usr/lib64/pkgconfig',21);
INSERT INTO "install_cmds" VALUES(111,32,'sed -i -e ''/^Libs/s:-lexpat:&w:'' expatw.pc','${BIN_DIR}/usr/lib64/pkgconfig',21);
INSERT INTO "install_cmds" VALUES(113,80,'','${SRC_DIR}/${PS}-${PV}',NULL);
INSERT INTO "install_cmds" VALUES(114,80,'','${SRC_DIR}/${PS}-${PV}',NULL);
INSERT INTO "install_cmds" VALUES(115,80,'','${SRC_DIR}/${PS}-${PV}',NULL);
INSERT INTO "install_cmds" VALUES(116,100,'make DESTDIR=${BIN_DIR} install','${BUILD_DIR}',NULL);
INSERT INTO "install_cmds" VALUES(117,101,'make DESTDIR=${BIN_DIR} install','${BUILD_DIR}',NULL);
INSERT INTO "install_cmds" VALUES(118,99,'make DESTDIR=${BIN_DIR} install','${BUILD_DIR}',NULL);
INSERT INTO "install_cmds" VALUES(119,71,'make DESTDIR=${BIN_DIR} install','${BUILD_DIR}',NULL);
INSERT INTO "install_cmds" VALUES(120,73,'mkdir -p ${BIN_DIR}/usr/{bin,share/man}','${SRC_DIR}/${PS}${PV}',NULL);
INSERT INTO "install_cmds" VALUES(121,73,'cp unzip funzip unzipsfx ${BIN_DIR}/usr/bin','${SRC_DIR}/${PS}${PV}',NULL);
INSERT INTO "install_cmds" VALUES(122,73,'ln -s unzip zipinfo','${BIN_DIR}/usr/bin',NULL);
INSERT INTO "install_cmds" VALUES(123,73,'mkdir -p ${BIN_DIR}/usr/share/man/man1','${SRC_DIR}/${PS}${PV}',NULL);
INSERT INTO "install_cmds" VALUES(124,73,'cp man/*.1 ${BIN_DIR}/usr/share/man/man1/','${SRC_DIR}/${PS}${PV}',NULL);
INSERT INTO "install_cmds" VALUES(125,91,'make DESTDIR=${BIN_DIR} install','${BUILD_DIR}',NULL);
INSERT INTO "install_cmds" VALUES(126,96,'install -v -m755 -d ${BIN_DIR}/usr/share/xml/docbook/xsl-stylesheets-${PV}','${SRC_DIR}/${PS}-${PV}',NULL);
INSERT INTO "install_cmds" VALUES(127,96,'cp -R VERSION assembly common eclipse epub epub3 extensions fo highlighting html htmlhelp images javahelp lib manpages params profiling roundtrip slides template tests tools webhelp website xhtml xhtml-1_1 xhtml5 ${BIN_DIR}/usr/share/xml/docbook/xsl-stylesheets-${PV}','${SRC_DIR}/${PS}-${PV}',NULL);
INSERT INTO "install_cmds" VALUES(128,96,'ln -s VERSION ${BIN_DIR}/usr/share/xml/docbook/xsl-stylesheets-${PV}/VERSION.xsl','${SRC_DIR}/${PS}-${PV}',NULL);
INSERT INTO "install_cmds" VALUES(129,96,'install -m644 -D README ${BIN_DIR}/usr/share/doc/docbook-xsl-${PV}/README.txt','${SRC_DIR}/${PS}-${PV}',NULL);
INSERT INTO "install_cmds" VALUES(130,96,'install -m644    RELEASE-NOTES* NEWS* ${BIN_DIR}/usr/share/doc/docbook-xsl-${PV}','${SRC_DIR}/${PS}-${PV}',NULL);
INSERT INTO "install_cmds" VALUES(131,96,'if [ ! -d ${BIN_DIR}/etc/xml ]; then install -m755 -d ${BIN_DIR}/etc/xml; fi','${SRC_DIR}/${PS}-${PV}',NULL);
INSERT INTO "install_cmds" VALUES(132,96,'if [ ! -f ${BIN_DIR}/etc/xml/catalog ]; then
    xmlcatalog --noout --create ${BIN_DIR}/etc/xml/catalog
fi','${SRC_DIR}/${PS}-${PV}',NULL);
INSERT INTO "install_cmds" VALUES(133,96,'xmlcatalog --noout --add "rewriteSystem" \
    ...
    ${BIN_DIR}/etc/xml/catalog','${SRC_DIR}/${PS}-${PV}',NULL);
...
INSERT INTO "install_cmds" VALUES(136,96,'xmlcatalog --noout --add "rewriteURI" \
           ...
           "/usr/share/xml/docbook/xsl-stylesheets-${PV}" \
    ${BIN_DIR}/etc/xml/catalog','${SRC_DIR}/${PS}-${PV}',NULL);
INSERT INTO "install_cmds" VALUES(137,97,'install -d -m755 ${BIN_DIR}/usr/share/xml/docbook/xml-dtd-${PV}','${SRC_DIR}',NULL);
INSERT INTO "install_cmds" VALUES(138,97,'install -v -d -m755 ${BIN_DIR}/etc/xml','${SRC_DIR}',NULL);
INSERT INTO "install_cmds" VALUES(139,97,'cp -af docbook.cat *.dtd ent/ *.mod ${BIN_DIR}/usr/share/xml/docbook/xml-dtd-${PV}','${SRC_DIR}',NULL);
...
xmlcatalog --noout --add "rewriteURI" \
    "http://www.oasis-open.org/docbook/xml/${PV}" \
    "file:///usr/share/xml/docbook/xml-dtd-${PV}" \
   ${BIN_DIR}/etc/xml/docbook','${SRC_DIR}',NULL);
...
xmlcatalog --noout --add "delegateURI" \
    "http://www.oasis-open.org/docbook/" \
    "file:///etc/xml/docbook" \
     ${BIN_DIR}/etc/xml/catalog','${SRC_DIR}',NULL);
...
INSERT INTO "install_cmds" VALUES(143,95,'make DESTDIR=${BIN_DIR} install','${BUILD_DIR}',NULL);
INSERT INTO "install_cmds" VALUES(144,102,'make DESTDIR=${BIN_DIR} install','${BUILD_DIR}',NULL);
INSERT INTO "install_cmds" VALUES(145,102,'make DESTDIR=${BIN_DIR} install-private-headers','${BUILD_DIR}',NULL);
INSERT INTO "install_cmds" VALUES(146,102,'ln -sf tclsh8.6 ${BIN_DIR}/usr/bin/tclsh','${BUILD_DIR}',NULL);
INSERT INTO "install_cmds" VALUES(147,102,'chmod 755 ${BIN_DIR}/usr/lib/libtcl8.6.so','${BUILD_DIR}',NULL);
INSERT INTO "install_cmds" VALUES(148,90,'make DESTDIR=${BIN_DIR} install','${BUILD_DIR}',NULL);
INSERT INTO "install_cmds" VALUES(149,92,'make DESTDIR=${BIN_DIR} install','${BUILD_DIR}',NULL);
INSERT INTO "install_cmds" VALUES(150,93,'make ${MAKEOPTS}','${BUILD_DIR}',NULL);
INSERT INTO "install_cmds" VALUES(151,74,'make DESTDIR=${BIN_DIR} install','${BUILD_DIR}',NULL);
INSERT INTO "install_cmds" VALUES(152,79,'make DESTDIR=${BIN_DIR} install','${BUILD_DIR}',NULL);
INSERT INTO "install_cmds" VALUES(153,89,'make DESTDIR=${BIN_DIR} install','${BUILD_DIR}',NULL);
INSERT INTO "install_cmds" VALUES(154,94,'make DESTDIR=${BIN_DIR} install','${BUILD_DIR}',NULL);
INSERT INTO "install_cmds" VALUES(155,86,'make DESTDIR=${BIN_DIR} install','${SRC_DIR}/${PS}-${PV}',NULL);
INSERT INTO "install_cmds" VALUES(157,87,'make DESTDIR=${BIN_DIR} install','${SRC_DIR}/${PS}-${PV}',NULL);
INSERT INTO "install_cmds" VALUES(158,85,'make DESTDIR=${BIN_DIR} install','${SRC_DIR}/${PS}-${PV}',NULL);
INSERT INTO "install_cmds" VALUES(159,78,'make DESTDIR=${BIN_DIR} install','${BUILD_DIR}',NULL);
INSERT INTO "install_cmds" VALUES(160,77,'make DESTDIR=${BIN_DIR} install','${BUILD_DIR}',NULL);
INSERT INTO "install_cmds" VALUES(161,84,'make ${OPT net EXPYN NET} ${OPT pci EXPYN PCI} ${OPT udev EXPYN UDEV} ${OPT usb EXPYN USB} DESTDIR=${BIN_DIR} install DOCDIR=/usr/share/doc/${PN} MISCDIR=/usr/share/misc HWDBDIR=/lib/udev/hwdb.d','${SRC_DIR}/${PS}-${PV}',NULL);
INSERT INTO "install_cmds" VALUES(162,88,'make GIT=true DESTDIR=${BIN_DIR} install','${SRC_DIR}/${PS}-${PV}',NULL);
INSERT INTO "install_cmds" VALUES(163,103,'make DESTDIR=${BIN_DIR} htmldocdir=/usr/share/doc/${PN}/html install','${BUILD_DIR}',NULL);
INSERT INTO "install_cmds" VALUES(165,72,'make DESTDIR=${BIN_DIR} install','${BUILD_DIR}',NULL);
INSERT INTO "install_cmds" VALUES(167,76,'make DESTDIR=${BIN_DIR} docdir=/usr/share/doc/db-${PV} install','${BUILD_DIR}',NULL);
INSERT INTO "install_cmds" VALUES(168,104,'make DESTDIR=${BIN_DIR} install','${BUILD_DIR}',NULL);
INSERT INTO "install_cmds" VALUES(169,105,'make DESTDIR=${BIN_DIR} install','${BUILD_DIR}',NULL);
INSERT INTO "install_cmds" VALUES(171,14,'make DESTDIR=${BIN_DIR} install','${BUILD_DIR}/t_unicode',21);
INSERT INTO "install_cmds" VALUES(173,27,'rm -rf ${BIN_DIR}/usr/lib64/bash','',NULL);
INSERT INTO "install_cmds" VALUES(174,34,'mv usr/lib usr/lib64','${BIN_DIR}',NULL);
INSERT INTO "install_cmds" VALUES(175,7,'mv usr/lib/ldscripts usr/lib64/ && rm -r usr/lib','${BIN_DIR}',NULL);
INSERT INTO "install_cmds" VALUES(178,3,'touch ${BIN_DIR}/etc/ld.so.conf','${BIN_DIR}',NULL);
INSERT INTO "install_cmds" VALUES(179,3,'make DESTDIR=${BIN_DIR} install','${BUILD_DIR}',NULL);
INSERT INTO "install_cmds" VALUES(181,85,'mv usr/lib usr/lib64','${BIN_DIR}',NULL);
INSERT INTO "install_cmds" VALUES(183,87,'mv usr/lib usr/lib64','${BIN_DIR}',NULL);
INSERT INTO "install_cmds" VALUES(184,35,'mv usr/lib usr/lib64','${BIN_DIR}',NULL);
INSERT INTO "install_cmds" VALUES(185,107,'make DESTDIR=${BIN_DIR} install','${BUILD_DIR}',NULL);
INSERT INTO "install_cmds" VALUES(186,106,'make DESTDIR=${BIN_DIR} install','${BUILD_DIR}',NULL);
INSERT INTO "install_cmds" VALUES(187,75,'make DESTDIR=${BIN_DIR} install sepermitlockdir=/run/sepermit','${BUILD_DIR}',NULL);
INSERT INTO "install_cmds" VALUES(188,70,'mkdir -p ${BIN_DIR}','${SRC_DIR}/',NULL);
INSERT INTO "install_cmds" VALUES(189,70,'mv * ${BIN_DIR}','${SRC_DIR}/',NULL);
INSERT INTO "install_cmds" VALUES(190,81,'make DESTDIR=${BIN_DIR} install','${BUILD_DIR}',NULL);
INSERT INTO "install_cmds" VALUES(191,71,'mv usr/lib usr/lib64','${BIN_DIR}',NULL);
INSERT INTO "install_cmds" VALUES(192,42,'mv usr/lib/* usr/lib64/','${BIN_DIR}',NULL);
INSERT INTO "install_cmds" VALUES(193,42,'rm -r usr/lib','${BIN_DIR}',NULL);
INSERT INTO "install_cmds" VALUES(195,108,'make DESTDIR=${BIN_DIR} PREFIX=/usr LIBDIR=/usr/lib64 -C librhash install-lib-shared install-so-link','${SRC_DIR}/${PS}-${PV}',NULL);
INSERT INTO "install_cmds" VALUES(196,108,'make DESTDIR=${BIN_DIR} PREFIX=/usr LIBDIR=/usr/lib64 install-shared','${SRC_DIR}/${PS}-${PV}',0);
INSERT INTO "install_cmds" VALUES(197,108,'make DESTDIR=${BIN_DIR} PREFIX=/usr LIBDIR=/usr/lib64 install-lib-static','${SRC_DIR}/${PS}-${PV}',2);
INSERT INTO "install_cmds" VALUES(198,108,'make DESTDIR=${BIN_DIR} PREFIX=/usr LIBDIR=/usr/lib64 -C librhash install-headers','${SRC_DIR}/${PS}-${PV}',NULL);
INSERT INTO "install_cmds" VALUES(199,108,'make DESTDIR=${BIN_DIR} PREFIX=/usr LIBDIR=/usr/lib64 install-gmo','${SRC_DIR}/${PS}-${PV}',5);
INSERT INTO "install_cmds" VALUES(200,86,'mv usr/lib usr/lib64','${BIN_DIR}',NULL);
...
INSERT INTO "config_cmds" VALUES(2,5,'${SRC_DIR}/${PS}-${PV}/configure --shared --prefix=/usr --libdir=/usr/lib64 --sharedlibdir=/lib64','${SRC_DIR}/${PS}-${PV}',NULL);
INSERT INTO "config_cmds" VALUES(4,6,'${SRC_DIR}/${PS}-${PV}/configure ${CONFIG_DEF} ${OPT static-libs ENDIS static} ${OPT zlib ENDIS zlib}','${BUILD_DIR}',NULL);
...
INSERT INTO "config_cmds" VALUES(7,8,'${SRC_DIR}/${PS}-${PV}/configure ${CONFIG_DEF} --enable-cxx --disable-static --docdir=/usr/share/doc/${PN}-${PV}','${BUILD_DIR}',NULL);
INSERT INTO "config_cmds" VALUES(8,9,'${SRC_DIR}/${PS}-${PV}/configure ${CONFIG_DEF} --disable-static --enable-thread-safe --docdir=/usr/share/doc/${PN}-${PV}','${BUILD_DIR}',NULL);
INSERT INTO "config_cmds" VALUES(9,10,'${SRC_DIR}/${PS}-${PV}/configure ${CONFIG_DEF} --disable-static --docdir=/usr/share/doc/${PN}-${PV}','${BUILD_DIR}',NULL);
...
INSERT INTO "config_cmds" VALUES(13,13,'${SRC_DIR}/${PS}-${PV}/configure ${CONFIG_DEF} --with-internal-glib --disable-compile-warnings --disable-host-tool --docdir=/usr/share/doc/${PN}-${PV}','${BUILD_DIR}',NULL);
...
INSERT INTO "config_cmds" VALUES(15,15,'${SRC_DIR}/${PS}-${PV}/configure ${CONFIG_DEF} ${OPT static-libs ENDIS static}','${SRC_DIR}/${PS}-${PV}',NULL);
INSERT INTO "config_cmds" VALUES(16,16,'${SRC_DIR}/${PS}-${PV}/configure ${CONFIG_DEF} --libexecdir=/usr/lib64 ${OPT static-libs ENDIS static}','${SRC_DIR}/${PS}-${PV}',NULL);
INSERT INTO "config_cmds" VALUES(17,18,'${SRC_DIR}/${PS}-${PV}/configure ${CONFIG_DEF} --bindir=/bin --htmldir=/usr/share/doc/${PN}-${PV} ${OPT acl ENDIS acl} ${OPT nls ENDIS nls}','${BUILD_DIR}',NULL);
INSERT INTO "config_cmds" VALUES(18,19,'${SRC_DIR}/${PS}-${PV}/configure ${CONFIG_DEF} --without-group-name-max-length --without-tcb --enable-shared=no --enable-static=yes ${OPT acl WITHIO acl} ${OPT cracklib WITHIO libcrack} ${OPT pam WITHIO libpam} ${OPT nls ENDIS nls} ${OPT xattr WITHIO attr}','${BUILD_DIR}',NULL);
INSERT INTO "config_cmds" VALUES(19,20,'${SRC_DIR}/${PS}-${PV}/configure ${CONFIG_DEF} --disable-harden-flags ${OPT ipv6 ENDIS ipv6} ${OPT nls ENDIS nls}','${BUILD_DIR}',NULL);
INSERT INTO "config_cmds" VALUES(20,22,'${SRC_DIR}/${PS}-${PV}/configure ${CONFIG_DEF}','${BUILD_DIR}',NULL);
INSERT INTO "config_cmds" VALUES(21,23,'${SRC_DIR}/${PS}-${PV}/configure ${CONFIG_DEF} --docdir=/usr/share/doc/${PN}-${PV} ${OPT nls ENDIS nls}','${BUILD_DIR}',NULL);
INSERT INTO "config_cmds" VALUES(22,24,'${SRC_DIR}/${PS}-${PV}/configure ${CONFIG_DEF} --docdir=/usr/share/doc/${PN}-${PV} --disable-shared ${OPT nls ENDIS nls}','${BUILD_DIR}',NULL);
INSERT INTO "config_cmds" VALUES(23,25,'${SRC_DIR}/${PS}-${PV}/configure ${CONFIG_DEF} --bindir=/bin ${OPT nls ENDIS nls} ${OPT pcre ENDIS perl-regexp}','${BUILD_DIR}',0);
INSERT INTO "config_cmds" VALUES(24,26,'bash_cv_termcap_lib=ncurses CPPFLAGS="${CPPFLAGS} -D_GNU_SOURCE -Dxrealloc=_rl_realloc -Dxmalloc=_rl_malloc -Dxfree=_rl_free" LDFLAGS="${LDFLAGS} -L." ${SRC_DIR}/${PS}-${PV}/configure ${CONFIG_DEF} ${OPT static-libs ENDIS static} --docdir=/usr/share/doc/${PN}-${PV} --with-curses','${BUILD_DIR}',NULL);
...
INSERT INTO "config_cmds" VALUES(26,28,'${SRC_DIR}/${PS}-${PV}/configure ${CONFIG_DEF} --with-readline --mandir=/usr/share/man --infodir=/usr/share/info','${BUILD_DIR}',NULL);
INSERT INTO "config_cmds" VALUES(27,29,'${SRC_DIR}/${PS}-${PV}/configure ${CONFIG_DEF}','${BUILD_DIR}',NULL);
INSERT INTO "config_cmds" VALUES(28,30,'${SRC_DIR}/${PS}-${PV}/configure ${CONFIG_DEF} --includedir=/usr/include/gdbm ${OPT berkdb ENDIS libgdbm-compat} ${OPT nls ENDIS nls} ${OPT static-libs ENDIS static}','${BUILD_DIR}',NULL);
INSERT INTO "config_cmds" VALUES(29,31,'${SRC_DIR}/${PS}-${PV}/configure ${CONFIG_DEF} --docdir=/usr/share/doc/${PN}-${PV}','${BUILD_DIR}',NULL);
INSERT INTO "config_cmds" VALUES(30,32,'${SRC_DIR}/${PS}-${PV}/configure ${CONFIG_DEF} ${OPT static-libs ENDIS static}','${BUILD_DIR}',NULL);
INSERT INTO "config_cmds" VALUES(31,33,'${SRC_DIR}/${PS}-${PV}/configure ${CONFIG_DEF} --localstatedir=/var --disable-logger --disable-whois --disable-rcp --disable-rexec --disable-rlogin --disable-rsh --disable-servers','${BUILD_DIR}',NULL);
INSERT INTO "config_cmds" VALUES(32,34,'BUILD_ZLIB=False BUILD_BZIP2=0 sh Configure -Ui_ndbm ${OPT berkdb FLAGON -Di_ndbm} -${OPT gdbm FLAGOFF U}${OPT gdbm FLAGON D}i_gdbm -Ui_db ${OPT berkdb FLAGON -Di_db} -Dusethreads -DDEBUGGING=none ''-Dlibpth=/usr/lib64 /lib64 /lib/*-linux-gnu /usr/lib/*-linux-gnu /lib64 /lib/64 /usr/lib64 /usr/lib/64 /lib32 /usr/lib32 /lib /usr/lib'' -Dnoextensions=1 -Duseshrplib -Dprefix=/usr -Dsiteprefix=''/usr/local'' -Dvendorprefix=''/usr'' -Dscriptdir=''/usr/bin'' -Dman1ext=''1'' -Dman3ext=''3pm'' -Dman1dir=/usr/share/man/man1 -Dman3dir=/usr/share/man/man3 -Dlocincpth=''/usr/include '' -Duselargefiles -Dd_semctl_semun -Dcf_by=''LFS'' -Dmyhostname=''localhost'' -Dperladmin=''root@localhost'' -Ud_csh -Dsh=/bin/sh -Dtargetsh=/bin/sh -Uusenm -des -Dinstallprefix=''/usr''','${SRC_DIR}/${PS}-${PV}',NULL);
INSERT INTO "config_cmds" VALUES(33,35,'perl Makefile.PL PREFIX=/usr INSTALLMAN3DIR=''none'' INSTALLDIRS=vendor','${SRC_DIR}/${PS}-${PV}',NULL);
INSERT INTO "config_cmds" VALUES(34,36,'${SRC_DIR}/${PS}-${PV}/configure ${CONFIG_DEF}','${BUILD_DIR}',NULL);
INSERT INTO "config_cmds" VALUES(35,37,'${SRC_DIR}/${PS}-${PV}/configure ${CONFIG_DEF}','${BUILD_DIR}',NULL);
INSERT INTO "config_cmds" VALUES(36,38,'${SRC_DIR}/${PS}-${PV}/configure ${CONFIG_DEF} --docdir=/usr/share/doc/${PN}-${PV}','${BUILD_DIR}',NULL);
INSERT INTO "config_cmds" VALUES(37,39,'${SRC_DIR}/${PS}-${PV}/configure ${CONFIG_DEF} --docdir=/usr/share/doc/${PN}-${PV} ${OPT nls ENDIS nls} ${OPT static-libs ENDIS static} ${OPT threads ENDIS threads}','${BUILD_DIR}',NULL);
INSERT INTO "config_cmds" VALUES(38,40,'${SRC_DIR}/${PS}-${PV}/configure ${CONFIG_DEF} --enable-shared --bindir=/bin --with-rootlibdir=/lib64 ${OPT static-libs ENDIS static} ${OPT lzma WITHIO xz} ${OPT zlib WITHIO zlib} --with-bashcompletiondir=/usr/share/bash-completion/completions -disable-python','${BUILD_DIR}',NULL);
...
INSERT INTO "config_cmds" VALUES(41,43,'${SRC_DIR}/${PS}-${PV}/configure ${CONFIG_DEF} --exec-prefix= --docdir=/usr/share/doc/procps-ng-${PV} ${OPT static-libs ENDIS static} --disable-kill ${OPT ncurses WITHIO ncurses} ${OPT nls ENDIS nls} ${OPT systemd WITHIO systemd} ${OPT unicode ENDIS watch8bit}','${BUILD_DIR}',NULL);
INSERT INTO "config_cmds" VALUES(42,44,'${SRC_DIR}/${PS}-${PV}/configure ${CONFIG_DEF} --enable-symlink-install --enable-elf-shlibs --without-included-gettext ${OPT nls ENDIS nls} --disable-libblkid --disable-libuuid --disable-fsck --disable-uuidd','${BUILD_DIR}',NULL);
INSERT INTO "config_cmds" VALUES(43,45,'FORCE_UNSAFE_CONFIGURE=1 ${SRC_DIR}/${PS}-${PV}/configure ${CONFIG_DEF} --enable-no-install-program=kill,uptime --enable-largefile ${OPT caps ENDIS libcap} ${OPT nls ENDIS nls} ${OPT acl ENDIS acl} ${OPT multicall ENDIS single-binary} ${OPT xattr ENDIS xattr} ${OPT gmp WITHIO gmp}','${BUILD_DIR}',NULL);
INSERT INTO "config_cmds" VALUES(44,46,'${SRC_DIR}/${PS}-${PV}/configure ${CONFIG_DEF} ${OPT nls ENDIS nls}','${BUILD_DIR}',NULL);
INSERT INTO "config_cmds" VALUES(45,47,'${SRC_DIR}/${PS}-${PV}/configure ${CONFIG_DEF} --disable-depedency-tracking --disable-silent-rules --libexec=/usr/lib64/misc ${OPT mpfr WITHIO mpfr} ${OPT nls ENDIS nls} ${OPT readline WITHIO readline}','${BUILD_DIR}',NULL);
INSERT INTO "config_cmds" VALUES(46,48,'${SRC_DIR}/${PS}-${PV}/configure ${CONFIG_DEF} --localstatedir=/var/lib/locate --libexecdir=/usr/lib64 ${OPT nls ENDIS nls}','${BUILD_DIR}',NULL);
INSERT INTO "config_cmds" VALUES(47,49,'PAGE=A4 ${SRC_DIR}/${PS}-${PV}/configure ${CONFIG_DEF} --with-appresdir=/usr/share/X11/app-defaults --docdir=/usr/share/doc/${PN} ${OPT X WITHIO x}','${BUILD_DIR}',NULL);
INSERT INTO "config_cmds" VALUES(49,51,'${SRC_DIR}/${PS}-${PV}/configure ${CONFIG_DEF} --bindir=/bin','${BUILD_DIR}',NULL);
INSERT INTO "config_cmds" VALUES(50,53,'${SRC_DIR}/${PS}-${PV}/configure ${CONFIG_DEF} --disable-vlock','${BUILD_DIR}',NULL);
INSERT INTO "config_cmds" VALUES(51,54,'${SRC_DIR}/${PS}-${PV}/configure ${CONFIG_DEF} ${OPT static-libs ENDIS static}','${BUILD_DIR}',NULL);
INSERT INTO "config_cmds" VALUES(52,55,'${SRC_DIR}/${PS}-${PV}/configure ${CONFIG_DEF} ${OPT nls ENDIS nls} ${OPT guile WITHIO guile}','${BUILD_DIR}',NULL);
INSERT INTO "config_cmds" VALUES(53,56,'${SRC_DIR}/${PS}-${PV}/configure ${CONFIG_DEF} ${OPT xattr ENDIS xattr}','${BUILD_DIR}',NULL);
...
INSERT INTO "config_cmds" VALUES(57,60,'FORCE_UNSAFE_CONFIGURE=1 ${SRC_DIR}/${PS}-${PV}/configure ${CONFIG_DEF} --bindir=/bin ${OPT acl WITHIO posix-acls} ${OPT nls ENDIS nls} ${OPT xattr WITHIO xattrs}','${BUILD_DIR}',NULL);
INSERT INTO "config_cmds" VALUES(58,61,'${SRC_DIR}/${PS}-${PV}/configure ${CONFIG_DEF} --disable-static','${BUILD_DIR}',NULL);
INSERT INTO "config_cmds" VALUES(59,5,'minizip_opt','test_dir',1);
INSERT INTO "config_cmds" VALUES(61,50,'${OPT unicode EXPNY ac_cv_lib_ncurses_initscr} ${OPT unicode EXPYN ac_cv_lib_ncursesw_initscr} ${SRC_DIR}/${PS}-${PV}/configure ${CONFIG_DEF}','${BUILD_DIR}',NULL);
INSERT INTO "config_cmds" VALUES(62,62,'${SRC_DIR}/${PS}-${PV}/Configure linux-x86_64 --prefix=/usr --libdir=lib64 --openssldir=/etc/ssl shared zlib-dynamic threads enable-camellia enable-idea enable-mdc2 enable-rc5 enable-tlsext','${SRC_DIR}/${PS}-${PV}',NULL);
INSERT INTO "config_cmds" VALUES(63,63,'${SRC_DIR}/${PS}-${PV}/configure ${CONFIG_DEF} --disable-static --enable-threaded-resolver --with-ca-path=/etc/ssl/certs ${OPT ldap ENDIS ldap} ${OPT ldap ENDIS ldaps} ${OPT idn ENDIS libidn2}','${BUILD_DIR}',NULL);
...
INSERT INTO "config_cmds" VALUES(65,65,'${SRC_DIR}/${PS}-${PV}/configure ${CONFIG_DEF}','${BUILD_DIR}',NULL);
INSERT INTO "config_cmds" VALUES(66,66,'yes "" | ./configure.sh config.in','${SRC_DIR}/${PS}-${PV}',NULL);
INSERT INTO "config_cmds" VALUES(67,68,'${SRC_DIR}/${PS}-${PV}/configure ${CONFIG_DEF} --disable-assert --disable-rpath ${OPT idn ENDIS iri} ${OPT ipv6 ENDIS ipv6} ${OPT nls ENDIS nls} ${OPT pcre ENDIS pcre} ${OPT ssl ENDIS digest} ${OPT ssl ENDIS opie} ${OPT idn WITHIO libidn} ${OPT ssl WITH -ssl=openssl} ${OPT zlib WITHIO zlib}','${BUILD_DIR}',NULL);
...
INSERT INTO "config_cmds" VALUES(69,32,'CPPFLAGS="${CPPFLAGS} -DXML_UNICODE" ${SRC_DIR}/${PS}-${PV}/configure ${CONFIG_DEF} ${OPT static-libs ENDIS static}','${BUILD_DIR}u',21);
INSERT INTO "config_cmds" VALUES(70,32,'CPPFLAGS="${CPPFLAGS} -DXML_UNICODE_WCHAR_T" ${SRC_DIR}/${PS}-${PV}/configure ${CONFIG_DEF} ${OPT static-libs ENDIS static}','${BUILD_DIR}w',21);
INSERT INTO "config_cmds" VALUES(71,71,'cmake -G "Unix Makefiles" -DCMAKE_INSTALL_PREFIX=/usr ${OPT static-libs EXPNY -DBUILD_STATIC_LIBS} -DCMAKE_BUILD_TYPE=LFS   ${SRC_DIR}/${PS}-${PV}/contrib/cmake_unofficial','${BUILD_DIR}',NULL);
...
INSERT INTO "config_cmds" VALUES(74,83,'mkdir -p ${BIN_DIR}/usr/sbin','${BUILD_DIR}',NULL);
INSERT INTO "config_cmds" VALUES(75,83,'install -vm755 ${PKG_SOURCES}/make-ca.sh-20170119 ${BIN_DIR}/usr/sbin/make-ca.sh','${BUILD_DIR}',NULL);
...
INSERT INTO "config_cmds" VALUES(77,101,'${SRC_DIR}/${PS}-${PV}/configure ${CONFIG_DEF} --enable-shared ${OPT static-libs ENDIS static} --docdir=/usr/share/doc/${PN}-${PV}','${BUILD_DIR}',NULL);
...
INSERT INTO "config_cmds" VALUES(79,95,'LINKS="/usr/bin/links" ${SRC_DIR}/${PS}-${PV}/configure ${CONFIG_DEF}','${BUILD_DIR}',NULL);
INSERT INTO "config_cmds" VALUES(80,102,'${SRC_DIR}/${PS}${PV}/unix/configure ${CONFIG_DEF} $([ $(uname -m) = x86_64 ] && echo --enable-64bit)','${BUILD_DIR}',NULL);
INSERT INTO "config_cmds" VALUES(81,90,'${SRC_DIR}/${PS}/source/configure ${CONFIG_DEF} --disable-renaming --disable-samples --disable-layoutex ${OPT static-libs ENDIS static}','${BUILD_DIR}',NULL);
INSERT INTO "config_cmds" VALUES(82,92,'${SRC_DIR}/${PS}-${PV}/configure ${CONFIG_DEF}','${BUILD_DIR}',NULL);
INSERT INTO "config_cmds" VALUES(83,93,'${SRC_DIR}/${PS}-${PV}/configure ${CONFIG_DEF} --enable-threads ${OPT nls ENDIS nls} ${OPT static-libs ENDIS static}','${BUILD_DIR}',NULL);
INSERT INTO "config_cmds" VALUES(84,74,'${SRC_DIR}/${PS}-${PV}/configure ${CONFIG_DEF} --enable-ltdl-install ${OPT static-libs ENDIS static}','${BUILD_DIR}',NULL);
...
INSERT INTO "config_cmds" VALUES(86,89,'${SRC_DIR}/${PS}-${PV}/configure ${CONFIG_DEF} ${OPT icu WITHIO icu} ${OPT lzma WITHIO lzma} ${OPT ipv6 ENDIS ipv6} ${OPT static-libs ENDIS static} ${OPT readline WITHIO readline} ${OPT readline WITHIO history}','${BUILD_DIR}',NULL);
INSERT INTO "config_cmds" VALUES(87,94,'${SRC_DIR}/${PS}-${PV}/configure ${CONFIG_DEF} --docdir=/usr/share/doc/${PN} --with-html-subdir=html ${OPT crypt WITHIO crypto} ${OPT static-libs ENDIS static}','${BUILD_DIR}',NULL);
INSERT INTO "config_cmds" VALUES(88,86,'perl Makefile.PL PREFIX=/usr INSTALLMAN3DIR=''none'' INSTALLDIRS=vendor','${SRC_DIR}/${PS}-${PV}',NULL);
INSERT INTO "config_cmds" VALUES(89,87,'perl Makefile.PL PREFIX=/usr INSTALLMAN3DIR=''none'' INSTALLDIRS=vendor','${SRC_DIR}/${PS}-${PV}',NULL);
INSERT INTO "config_cmds" VALUES(90,85,'perl Makefile.PL PREFIX=/usr INSTALLMAN3DIR=''none'' INSTALLDIRS=vendor','${SRC_DIR}/${PS}-${PV}',NULL);
INSERT INTO "config_cmds" VALUES(91,78,'${SRC_DIR}/${PS}-${PV}/configure ${CONFIG_DEF} --enable-devel --enable-shared ${OPT nftables ENDIS nftables} ${OPT caps ENDIS bpf-compiler} ${OPT caps ENDIS nfsynproxy} ${OPT static-libs ENDIS static} ${OPT ipv6 ENDIS ipv6}','${BUILD_DIR}',NULL);
INSERT INTO "config_cmds" VALUES(92,77,'${SRC_DIR}/${PS}-${PV}/configure ${CONFIG_DEF} ${OPT ipv6 ENDIS ipv6} ${OPT kerberos ENDIS gssapi} ${OPT static-libs ENDIS static}','${BUILD_DIR}',NULL);
...
INSERT INTO "config_cmds" VALUES(94,72,'${SRC_DIR}/${PS}-${PV}/configure ${CONFIG_DEF} --with-default-dict=''/usr/lib/cracklib_dict'' --without-python ${OPT nls ENDIS nls} ${OPT static-libs ENDIS static}','${BUILD_DIR}',NULL);
INSERT INTO "config_cmds" VALUES(96,76,'STRIP="true" ${SRC_DIR}/${PS}-${PV}/dist/configure ${CONFIG_DEF} ${OPT tcl ENDIS tcl} --enable-compat185 --enable-dbm --enable-o_direct --without-uniquename --enable-sql --enable-sql_codegen --disable-sql_compat --with-mutex=x86/gcc-assembly ${OPT cxx ENDIS cxx} ${OPT cxx ENDIS stl}','${BUILD_DIR}',NULL);
INSERT INTO "config_cmds" VALUES(97,104,'${SRC_DIR}/${PS}-${PV}/configure ${CONFIG_DEF} ${OPT static-libs ENDIS static}','${BUILD_DIR}',NULL);
INSERT INTO "config_cmds" VALUES(98,105,'${SRC_DIR}/${PS}-${PV}/configure ${CONFIG_DEF} ${OPT static-libs ENDIS static}','${BUILD_DIR}',NULL);
INSERT INTO "config_cmds" VALUES(99,14,'${SRC_DIR}/${PS}-${PV}/configure ${CONFIG_DEF} --enable-pc-files --with-shared --without-hashed-db ${OPT cxx WITHIO cxx} ${OPT cxx WITHIO cxx-binding} --with-cxx-shared ${OPT gpm WITHIO gpm} --disable-termcap --enable-symlinks --with-rcs-ids --with-manpage-format=normal --enable-const --enable-colorfgbg --enable-hard-tabs --enable-echo --enable-warnings ${OPT tinfo WITHIO termlib} --enable-widec ${OPT threads WITHIO pthread} ${OPT threads WITHIO reentrant}  --includedir=/usr/include/ncursesw','${BUILD_DIR}/t_unicode',21);
INSERT INTO "config_cmds" VALUES(102,106,'${SRC_DIR}/${PS}-${PV}/configure ${CONFIG_DEF} ${OPT xattr ENDIS xattr} ${OPT static-libs ENDIS static} --disable-compile-warnings --enable-man --with-pcre=system --with-xml-catalog=/etc/xml/catalog --with-threads=posix --disable-gtk-doc --disable-man','${BUILD_DIR}',NULL);
INSERT INTO "config_cmds" VALUES(103,107,'${SRC_DIR}/${PS}-${PV}/configure ${CONFIG_DEF} ${OPT static-libs ENDIS static}','${BUILD_DIR}',NULL);
...
INSERT INTO "config_cmds" VALUES(105,81,'${SRC_DIR}/${PS}-${PV}/configure ${CONFIG_DEF} ${OPT static-libs ENDIS static} --disable-python','${BUILD_DIR}',NULL);
...
INSERT INTO "make_cmds" VALUES(2,4,'make ${MAKEOPTS} TOPDIR=/usr REDO=posix_only','${SRC_DIR}',NULL);
...
INSERT INTO "make_cmds" VALUES(10,11,'make ''LDFLAGS=-Wl,-O1 -Wl,--as-needed'' ''LIBPATH=/usr/lib64/gcc/$(gcc -dumpmachine)/${PV}'' ''BOOT_CFLAGS=-m64 -O2 -pipe'' bootstrap-lean ${MAKEOPTS}','${BUILD_DIR}',NULL);
...
INSERT INTO "make_cmds" VALUES(25,26,'make ${MAKEOPTS}','${BUILD_DIR}',NULL);
...
INSERT INTO "make_cmds" VALUES(74,82,'','',NULL);
INSERT INTO "make_cmds" VALUES(76,98,'','',NULL);
INSERT INTO "make_cmds" VALUES(77,90,'make ${MAKEOPTS}','${BUILD_DIR}',NULL);
INSERT INTO "make_cmds" VALUES(78,92,'make ${MAKEOPTS}','${BUILD_DIR}',NULL);
INSERT INTO "make_cmds" VALUES(79,93,'make DESTDIR=${BIN_DIR} install','${BUILD_DIR}',NULL);
INSERT INTO "make_cmds" VALUES(80,74,'make ${MAKEOPTS}','${BUILD_DIR}',NULL);
INSERT INTO "make_cmds" VALUES(81,79,'make ${MAKEOPTS}','${BUILD_DIR}',NULL);
INSERT INTO "make_cmds" VALUES(82,89,'make ${MAKEOPTS}','${BUILD_DIR}',NULL);
INSERT INTO "make_cmds" VALUES(83,94,'make ${MAKEOPTS}','${BUILD_DIR}',NULL);
INSERT INTO "make_cmds" VALUES(84,86,'make ${MAKEOPTS}','${SRC_DIR}/${PS}-${PV}',NULL);
INSERT INTO "make_cmds" VALUES(85,87,'make ${MAKEOPTS}','${SRC_DIR}/${PS}-${PV}',NULL);
INSERT INTO "make_cmds" VALUES(86,85,'make ${MAKEOPTS}','${SRC_DIR}/${PS}-${PV}',NULL);
INSERT INTO "make_cmds" VALUES(87,78,'make ${MAKEOPTS} -C iptables xtables-config-parser.h','${BUILD_DIR}',471);
INSERT INTO "make_cmds" VALUES(88,77,'make ${MAKEOPTS}','${BUILD_DIR}',NULL);
INSERT INTO "make_cmds" VALUES(90,84,'make ${MAKEOPTS} ${OPT net EXPYN NET} ${OPT pci EXPYN PCI} ${OPT udev EXPYN UDEV} ${OPT usb EXPYN USB}','${SRC_DIR}/${PS}-${PV}',NULL);
INSERT INTO "make_cmds" VALUES(91,88,'make ${MAKEOPTS} ${OPT cracklib EXPNY CRACKLIB} ${OPT consolekit EXPNY CONSOLEKIT} ${OPT systemd EXPNY SYSTEMD} ${OPT nullok EXPNY NULLOK} ${OPT sha512 EXPNY SHA512} ${OPT minimal EXPNY MINIMAL} IMPLEMENTATION=linux-pam LINUX_PAM_VERSION=$(printf "0x%02x%02x%02x" $(echo "1.3.0" | sed -e ''s/\./ /g''))','${SRC_DIR}/${PS}-${PV}',NULL);
INSERT INTO "make_cmds" VALUES(92,72,'make ${MAKEOPTS}','${BUILD_DIR}',NULL);
INSERT INTO "make_cmds" VALUES(93,81,'make ${MAKEOPTS}','${BUILD_DIR}',NULL);
INSERT INTO "make_cmds" VALUES(94,75,'make ${MAKEOPTS} sepermitlockdir=/run/sepermit','${BUILD_DIR}',NULL);
INSERT INTO "make_cmds" VALUES(96,83,'cp ${PKG_SOURCES}/certdata.txt ./','${BUILD_DIR}',NULL);
INSERT INTO "make_cmds" VALUES(97,83,'${BIN_DIR}/usr/sbin/make-ca.sh --destdir ${BIN_DIR}','${BUILD_DIR}',NULL);
INSERT INTO "make_cmds" VALUES(98,100,'make ${MAKEOPTS}','${BUILD_DIR}',NULL);
INSERT INTO "make_cmds" VALUES(99,101,'make ${MAKEOPTS}','${BUILD_DIR}',NULL);
INSERT INTO "make_cmds" VALUES(100,99,'make ${MAKEOPTS}','${BUILD_DIR}',NULL);
INSERT INTO "make_cmds" VALUES(101,71,'make ${MAKEOPT}','${BUILD_DIR}',NULL);
INSERT INTO "make_cmds" VALUES(102,73,'CPPFLAGS="${CPPFLAGS} ${OPT bzip2 FLAGON -DUSE_BZIP2} ${OPT unicode FLAGON -DUNICODE_SUPPORT} ${OPT unicode FLAGON -DUNICODE_WCHAR} ${OPT unicode FLAGON -DUTF8_MAYBE_NATIVE} -DLARGE_FILE_SUPPORT}" make -f unix/Makefile ${MAKEOPTS} generic','${SRC_DIR}/${PS}${PV}',NULL);
INSERT INTO "make_cmds" VALUES(103,91,'make ${MAKEOPTS}','${BUILD_DIR}',NULL);
INSERT INTO "make_cmds" VALUES(104,95,'make ${MAKEOPTS}','${BUILD_DIR}',NULL);
INSERT INTO "make_cmds" VALUES(105,102,'make ${MAKEOPTS}','${BUILD_DIR}',NULL);
INSERT INTO "make_cmds" VALUES(106,78,'make ${MAKEOPTS}','${BUILD_DIR}',NULL);
INSERT INTO "make_cmds" VALUES(107,103,'make ${MAKEOPTS}','${BUILD_DIR}',NULL);
INSERT INTO "make_cmds" VALUES(109,76,'make ${MAKEOPTS}','${BUILD_DIR}',NULL);
INSERT INTO "make_cmds" VALUES(110,104,'make ${MAKEOPTS}','${BUILD_DIR}',NULL);
INSERT INTO "make_cmds" VALUES(111,105,'make ${MAKEOPTS}','${BUILD_DIR}',NULL);
INSERT INTO "make_cmds" VALUES(112,14,'make ${MAKEOPTS}','${BUILD_DIR}/t_unicode',21);
INSERT INTO "make_cmds" VALUES(113,4,'patch -Np1 -i ${PKG_SOURCES}timezone-data-2016g-makefile.patch','${SRC_DIR}',NULL);
INSERT INTO "make_cmds" VALUES(114,106,'make ${MAKEOPTS}','${BUILD_DIR}',NULL);
INSERT INTO "make_cmds" VALUES(115,107,'make ${MAKEOPTS}','${BUILD_DIR}',NULL);
INSERT INTO "make_cmds" VALUES(116,108,'make ${MAKEOPTS} ADDCFLAGS="${OPT nls FLAGON -DUSE_GETTEXT} ${OPT ssl FLAGON -DOPENSSL_RUNTIME} ${OPT ssl FLAGON -rdynamic}" ADDLDFLAGS="${OPT ssl FLAGON -ldl}" build-shared ${OPT static-libs FLAGON lib-static}','${SRC_DIR}/${PS}-${PV}',NULL);
...
INSERT INTO "sqlite_sequence" VALUES('prepare_cmds',118);
...
INSERT INTO "sqlite_sequence" VALUES('pkg_opts',312);
INSERT INTO "sqlite_sequence" VALUES('package_meta',110);
INSERT INTO "sqlite_sequence" VALUES('postinstall_cmds',136);
INSERT INTO "sqlite_sequence" VALUES('package_sources',134);
INSERT INTO "sqlite_sequence" VALUES('install_cmds',200);
